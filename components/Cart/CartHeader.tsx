...
const Header = async () => {
  ...
  return (
    <div className="fixed left-0 top-0 z-10 flex w-full items-center space-x-10 bg-zinc-800 p-5 md:space-x-0">
      ...
      <div className="flex items-center justify-end md:w-1/5">
        ...
        <div className="flex flex-col border-l-2 border-slate-600 pl-3">
